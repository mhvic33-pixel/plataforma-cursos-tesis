...
<body>
	...
	<div class="item">
        ...
        <a href="curso.php?id=1" class="btn-curso">Ver más</a>
    </div>
    ...
    <div class="item">
        ...
        <h3>EJERCICIO</h3>
        <a href="curso.php?id=2" class="btn-curso">Ver más</a>
    </div>
    ...
    <div class="item">
        ...
        <a href="curso.php?id=3" class="btn-curso">Ver más</a>
    </div>
    ...
    <div class="item">
        ...
        <h5>MATEMATICAS</h5>
        <a href="curso.php?id=4" class="btn-curso">Ver más</a>
    </div>
    ...
    <div class="item">
        ...
        <a href="curso.php?id=5" class="btn-curso">Ver más</a>
    </div>
